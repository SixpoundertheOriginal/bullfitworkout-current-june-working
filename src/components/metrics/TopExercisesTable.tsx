...
export const TopExercisesTable: React.FC<TopExercisesTableProps> = ({ exerciseVolumeHistory }) => {
  const { weightUnit } = useWeightUnit();
  
  if (!exerciseVolumeHistory || exerciseVolumeHistory.length === 0) {
    return (
    ...
    <Table>
      ...
      <TableBody>
        {exerciseVolumeHistory.map((exercise) => (
          <TableRow key={exercise.exercise_name} className="border-gray-800 hover:bg-gray-800/50">
