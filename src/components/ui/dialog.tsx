...
>(({ className, children, ...props }, ref) => {
  // Generate unique IDs for aria-labelledby and aria-describedby if not provided
  const titleId = React.useId();
  const descriptionId = React.useId();
  
  // Use provided aria attributes or fall back to generated IDs
    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          "max-h-[90vh] overflow-y-auto",  // Added max height and overflow for better mobile experience and to ensure scroll is on the dialog, not the page
          className
        )}
